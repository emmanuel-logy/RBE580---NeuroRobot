...
int main(int argc, char* argv[])
{
  ...
  vtkNew<vtkCylinderSource> sphere1;
  sphere1->SetRadius(0.29);
  sphere1->SetCenter(-1.0, 0, 0);

  vtkNew<vtkLineSource> lineSource;
  lineSource->SetPoint1(-1.0, 1.0, 0.0);
  ...
  collide->SetInputConnection(1, tubeFilter->GetOutputPort());
  ...
  for (int i = 0; i < numSteps; ++i)
  {
    ...
    lineSource->SetPoint1(xLine, yLine, zLine);
